package com.emasphere.testreactormongo;

import com.emasphere.testreactormongo.model.Movement;
import com.emasphere.testreactormongo.repository.MovementRepository;
...
public class TestReactorMongoApplication {

    private static final Logger logger = LoggerFactory.getLogger(TestReactorMongoApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(TestReactorMongoApplication.class, args);
    }
